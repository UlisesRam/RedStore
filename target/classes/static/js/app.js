...
function cartHTML() {
    ...
    cartItems.forEach(item => {
        ...
        <td>
            <a class="incQuantity" onclick="increaseQuantity()" data-id="${id}">+</a>
            <a class="decQuantity" onclick="decreaseQuantity()" data-id="${id}">-</a>
...
getPrice = function() {
    ...
    if(coupon){ //Si se aplica el cupon existente
		...
		alert("Coupon not valid for this articles")
...
function getHref(){
	Swal.fire({
  title: 'Are you sure go to Payment?',
